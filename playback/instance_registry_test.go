...
func TestInstanceRegistrySnapshotsMaterializeCopies(t *testing.T) {
	...
	registry.register(&Instance{
		ID: "audio", MediaType: "audio", OutputID: "main",
		BackendStarted: true, PositionMs: 250, PositionAt: started,
	})
...
func TestInstanceRegistryRemoveCueRetiresOnlyMatchingInstances(t *testing.T) {
	...
	registry.register(&Instance{ID: "first-a", CueID: first})
	registry.register(&Instance{ID: "first-b", CueID: first})
	registry.register(&Instance{ID: "second", CueID: second})
