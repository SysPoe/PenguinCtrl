...
func TestNormalizeOperatorWindowSupportsEmergencyFallbackSizes(t *testing.T) {
	settings := normalize(Settings{OperatorUISettings: OperatorUISettings{OperatorWindow: WindowPlacement{Width: 100, Height: 100}}})
	...
	settings = normalize(Settings{OperatorUISettings: OperatorUISettings{OperatorWindow: WindowPlacement{Width: 9000, Height: 9000}}})
